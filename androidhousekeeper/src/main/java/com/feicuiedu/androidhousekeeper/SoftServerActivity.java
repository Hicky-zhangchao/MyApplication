...
public class SoftServerActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.softserver_activity);
...
//                    Log.d("demo","soft: " + i + "---" + name + "---" + packageName);
                ...
                builder.setPositiveButton("确认卸载", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
    ...
    public void uninstApp(){
        ...
        if(n < list_del.size()){
            ...
            Toast.makeText(getApplicationContext(), "系统软件无法完全卸载", Toast.LENGTH_SHORT).show();
        }
